...
public class MainMenuTesting extends ParentFrame {

    public final static int FRAMES_PER_SECOND = 60;
    private Game game;
    
    public MainMenuTesting() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    if (game == null) {
                        ...
                        game.startGame(GameManager.GameState.PLAYING);
                    } 
                    else
    ...
    public static void main(String[] args) {
        MainMenuTesting mainMenu = new MainMenuTesting();
